package edu.training.news_portal.pool;
...
public final class ConnectionPool {
    ...
    public static synchronized ConnectionPool getFirstInstance(String url, String user, String password,int poolSize) throws SQLException, ClassNotFoundException {
        if(instance == null){
    ...
    public void close() throws SQLException {
        ...
        try {
            ...
            throw new SQLException("Connection closing error", e);
        }
    }
