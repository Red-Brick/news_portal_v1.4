...
<main class="main-content">
    <div class="auth-container">
        ...
        <c:if test="${not empty param.registrationError && param.registrationError == 'true'}">
            <div class="auth-error">Ошибка регистрации. Проверьте введенные данные.</div>
            <c:set var="registrationError" value="" scope="session"/>
        </c:if>

        <c:if test="${not empty param.emailExists && param.emailExists == 'true'}">
